...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        ...
        $sql = "INSERT INTO utilisateurs (nom, email, pass, photo) VALUES (:nom, :email, :pass, :photo)";
...
<header class="header">
    ...
    <section class="flex">
        ...
        <a href="src/views/home.php" class="logo">Nunya</a>
        ...
        <div class="profile">
            <img src="src/assets/images/pic-1.jpg" class="image" alt="">
            <h3 class="name">Abalo Kossi</h3>
            <p class="role">Etudiant</p>
            <a href="src/views/profile.html" class="btn">Voir Profile</a>
            <div class="flex-btn">
                <a href="src/views/auth/login.html" class="option-btn">Connexion</a>
                <a href="src/views/auth/register.html" class="option-btn">Inscription</a>
            </div>
        </div>
...
<div class="side-bar">
    ...
    <nav class="navbar">
        <a href="src/views/home.php"><i class="fas fa-home"></i><span>Accueil</span></a>
        <a href="src/views/about.html"><i class="fas fa-question"></i><span>A Propos</span></a>
        <a href="src/views/courses.html"><i class="fas fa-graduation-cap"></i><span>cours</span></a>
        <a href="src/views/teachers.html"><i class="fas fa-chalkboard-user"></i><span>Enseignants</span></a>
        <a href="src/views/contact.html"><i class="fas fa-headset"></i><span>Contactez-nous</span></a>
    </nav>
...
<section class="form-container">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <input type="password" name="c_pass" placeholder="Confirmer le mot de passe" required maxlength="20"
               class="box">
        <p>Photo <span>*</span></p>
